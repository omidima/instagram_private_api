...
class TimelineFeed
  ...
  @override
  Future<FeedTimelineResponse> request() async {
    var data = await client.request.post('/api/v1/feed/timeline/', form: {
      'is_prefetch': '0',
      'feed_view_info': '',
      'seen_posts': '',
      ...
      if (reason == RequestReason.pagination) 'max_id': _nextMaxId
    }, headers: {
    ...
    print(data);
    return FeedTimelineResponse.fromJson(data.data);
  }
